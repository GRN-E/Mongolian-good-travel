...
export default function CTA() {
  const t = useT()
  return (
    <section id="contact" className="py-14 sm:py-20 md:py-28 bg-white">
      <div className="container-x">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-blue via-brand-blue to-brand-blue-deep text-white px-5 py-10 sm:px-7 sm:py-14 md:px-16 md:py-20 lg:px-20 lg:py-24">
          ...
          <div className="relative grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7">
              ...
              <h2 className="h-display mt-4 text-3xl sm:text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
                {(() => {
