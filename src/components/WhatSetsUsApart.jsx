        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          <div className="lg:col-span-5 relative">
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -right-6 md:-right-10 bg-white rounded-2xl shadow-card-hover p-5 max-w-xs ring-1 ring-line"
            >
          ...
          <div className="lg:col-span-6 lg:col-start-7">
            <Reveal>
              ...
              <h2 className="h-display mt-4 text-4xl md:text-5xl lg:text-6xl text-ink">{t(ui.titleApart)}</h2>
