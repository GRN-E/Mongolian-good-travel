...
export default function PageHero({ eyebrow, title, subtitle, image, breadcrumbs = [] }) {
  ...
  return (
    <section className="relative">
      <div className="relative h-[300px] sm:h-[360px] md:h-[480px] overflow-hidden bg-brand-blue-deep">
        {image && (
          <img
            src={image}
            alt=""
        ...
        <div className="relative h-full container-x flex flex-col justify-end pb-12 md:pb-16 text-white">
          ...
          <h1 className="h-display text-3xl sm:text-4xl md:text-6xl lg:text-7xl">{t(title)}</h1>
          {subtitle && (
