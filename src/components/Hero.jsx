  ...
  return (
    <section id="top" className="relative">
      <div className="relative h-[640px] md:h-[720px] overflow-hidden">
        ...
        <div className="relative h-full container-x flex flex-col justify-end pb-44 md:pb-52">
          <div className="max-w-3xl text-white">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h1 className="h-display text-5xl md:text-7xl lg:text-[5.5rem] text-white">
                  {t(slide.title)}
                </h1>
          ...
          <div className="absolute bottom-44 right-6 md:bottom-52 md:right-12 flex gap-2">
      ...
      <motion.div
        ...
        className="container-x relative -mt-24 md:-mt-28 z-10"
      >
        <SearchWidget />
      </motion.div>
    </section>
